...
$helptxt['cb'] = '<b>Custom blocks</b><br />
	Allows to show custom blocks:<br />
	<ul class="normallist">
		<li>Above the forum header.</li>
		<li>Instead of default header of forum.</li>
		<li>Below the forum header.</li>
		<li>Above the forum footer.</li>
		<li>Instead of default footer of forum.</li>
		<li>Below the forum footer.</li>
	</ul>
	Can be define any number of blocks through several parameters:<br />
	<ul class="normallist">
		<li>Frame: HTML code with attributes for <tt>DIV</tt> tag which skirts the content of the block. If left empty is not put <tt>DIV</tt> tag. Through <tt>style</tt> or <tt>class</tt> attributes (CSS styles and classes) may indicate position, size and others characteristics of the block.</li>
		<li>Type: A block can contain HTML code (the default option), BBC or PHP.</li>
		<li>Content: Content of the block. Position, size and others characteristics of the block may be indicated here or in frame. Can be used the following variables:<br />
			<ul class="normallist">
				<li><tt>{COPYRIGHT}</tt> - Copyright of the forum.</li>
				<li><tt>{BOARDURL}</tt> - URL to forum folder.</li>
				<li><tt>{SCRIPTURL}</tt> - Web address of forum.</li>
				<li><tt>{IMAGES_URL}</tt> - URL to images folder in the users current theme.</li>
				<li><tt>{DEFAULT_IMAGES_URL}</tt> - URL to the images folder in the default theme.</li>
			</ul>
			Variable <tt>{COPYRIGHT}</tt> must be on some block of forum footer. If it is not, will be create a block with the text of copyright.</li>
		<li>Order: Position of the block in relation to the other blocks from left to right.</li>
		<li>Permissions: Indicates the user group that can see the block. By default none.</li>
		<li>Active: Indicates if a block is active. By default active.</li>
	</ul>
	For example, this block structure, height 50 px<br />
	<ul class="normallist">
		<li>Block 1, left aligned and 250 px width;</li>
		<li>Block 2, left aligned (to the right of Block 1) and 10% width of the window;</li>
		<li>Block 3, centered and automatic width;</li>
		<li>Block 4, right aligned and 150 px width;</li>
	</ul>
	can be defined as:<br />
	<ul class="normallist">
		<li>Block 1, order 1, frame: <tt><b>style=&quot;float: left; width: 250px; height: 50px;&quot;</b></tt></li>
		<li>Block 2, order 2, frame: <tt><b>style=&quot;float: left; width: 10%; height: 50px;&quot;</b></tt></li>
		<li>Block 3, order 4, frame: <tt><b>style=&quot;float: center; height: 50px;&quot;</b></tt></li>
		<li>Block 4, order 3, frame: <tt><b>style=&quot;float: right; width: 150px; height: 50px;&quot;</b></tt></li>
	</ul>';
$helptxt['cb_content'] = 'Content of the block. Position, size and others characteristics of the block may be indicated here or in frame. Can be used the following variables:<br />
	<ul class="normallist">
		<li><tt>{COPYRIGHT}</tt> - Copyright of the forum.</li>
		<li><tt>{BOARDURL}</tt> - URL to forum folder.</li>
		<li><tt>{SCRIPTURL}</tt> - Web address of forum.</li>
	...
	Variable <tt>{COPYRIGHT}</tt> must be on some block of forum footer. If it is not, will be create a block with the text of copyright.';
